...
export default function appController($state, authSrv) {
  ...
  // Utils functions
  const openModalMenu = () => { this.showModalMenu = true; };
  const openModalLogout = () => { this.showModalLogout = true; };
  const closeModalMenu = () => { this.showModalMenu = false; };
  const closeModalLogout = () => { this.showModalLogout = false; };
